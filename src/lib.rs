...
// to compile: cargo +nightly build --target wasm32-unknown-unknown
// to bind & glue code: wasm-bindgen target/wasm32-unknown-unknown/debug/wasm_example.wasm --out-dir .
